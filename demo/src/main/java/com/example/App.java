...
public class App {
    public static void main(String[] args) {
        ...
        /*
         * Party party = new Party(0, "Afghanistan", LocalDate.of(2003, 2, 10),
         * LocalDate.of(2003, 5, 01));
         * party.easyprint();
         */

        String all_parties = "Afghanistan, 2003-02-10, 2003-05-01" +
        ...
        for (String addingparties : all_parties.split("\n")) {
            String[] values = addingparties.split(",\\s*");
